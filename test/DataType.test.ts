...
describe('Options Contain', () => {
  it('should be return string equal to VARCHAR(30) NOT NULL', () => {
    expect(DataType.VARCHAR([keyword.NOT_NULL, 30])).toBe(
      'VARCHAR(30) NOT NULL',
    );
  });
  ...
  it('should be return string equal to VARCHAR(30) NOT NULL AUTO_INCREMENT', () => {
    expect(
      DataType.VARCHAR([keyword.NOT_NULL, keyword.AUTO_INCREMENT, 30]),
    ).toBe('VARCHAR(30) NOT NULL AUTO_INCREMENT');
  });
  ...
  it("should be return string equal to ENUM('Low', 'Medium', 'High') NOT NULL AUTO_INCREMENT", () => {
    ...
    ).toBe("ENUM('Low', 'Medium', 'High') NOT NULL AUTO_INCREMENT");
  });
});
...
describe('ENUM', () => {
  it("should be return string equal to ENUM('Low', 'Medium', 'High')", () => {
    expect(DataType.ENUM(['Low', 'Medium', 'High'])).toBe(
...
describe('SET', () => {
  it("should be return string equal to SET('Low', 'Medium', 'High')", () => {
    expect(DataType.SET(['Low', 'Medium', 'High'])).toBe(
      "SET('Low', 'Medium', 'High')",
    );
  });
});
