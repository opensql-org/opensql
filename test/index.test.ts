import { AUTO_INCREMENT, DataType, DEFAULT, NOT_NULL } from '../index';
import Builder from '../src/common/query/Builder';

const BuilderFactory = new Builder();
...
describe('Builder class', () => {
  describe('Create Database', () => {
    test('createDatabase and dropDatabase', () => {
      ...
      expect(BuilderFactory.createDatabase('simpleDB')).toBe(
        'CREATE DATABASE IF NOT EXISTS simpleDB CHARACTER SET UTF8 COLLATE UTF8_UNICODE_CI',
      );

      expect(BuilderFactory.dropDatabase('simpleDB')).toBe(
  ...
  describe('Drop Or Clear Table', () => {
    test('dropTable', () => {
      expect(BuilderFactory.dropTable('users')).toBe(
        'DROP TABLE IF EXISTS users',
      );
    });

    test('truncateTable', () => {
      expect(BuilderFactory.truncateTable('users')).toBe(
  ...
  describe('Create Table', () => {
    it('should be return CREATE TABLE IF NOT EXISTS users ( id INT NOT NULL AUTO_INCREMENT, email VARCHAR(255) NOT NULL, phone VARCHAR(20) )', () => {
      expect(
        ...
        'CREATE TABLE IF NOT EXISTS users ( id INT NOT NULL AUTO_INCREMENT, email VARCHAR(255) NOT NULL, phone VARCHAR(20) )',
      );
    });
    ...
    it('should be return CREATE TABLE IF NOT EXISTS users ( id INT NOT NULL AUTO_INCREMENT, email VARCHAR(255) NOT NULL, phone VARCHAR(20) , PRIMARY KEY (id) )', () => {
      expect(
        ...
        'CREATE TABLE IF NOT EXISTS users ( id INT NOT NULL AUTO_INCREMENT, email VARCHAR(255) NOT NULL, phone VARCHAR(20) , PRIMARY KEY (id) )',
      );
    });
    ...
    it('should be return CREATE TABLE IF NOT EXISTS users ( id INT NOT NULL AUTO_INCREMENT , FOREIGN KEY (id) REFERENCES books(user_id) , email VARCHAR(255) NOT NULL, phone VARCHAR(20) )', () => {
      expect(
        ...
        'CREATE TABLE IF NOT EXISTS users ( id INT NOT NULL AUTO_INCREMENT , FOREIGN KEY (id) REFERENCES books(user_id) , email VARCHAR(255) NOT NULL, phone VARCHAR(20) )',
      );
    });
    ...
    it("should be return CREATE TABLE IF NOT EXISTS users ( type VARCHAR, CHECK(type='Image' OR type= 'Location'), isReply BOOLEAN, location POINT )", () => {
      expect(
        ...
        "CREATE TABLE IF NOT EXISTS users ( type VARCHAR, CHECK(type='Image' OR type= 'Location'), isReply BOOLEAN, location POINT )",
      );
    });
    ...
    it("should be return CREATE TABLE IF NOT EXISTS users ( id INT DEFAULT 'Low' )", () => {
      ...
      ).toBe("CREATE TABLE IF NOT EXISTS users ( id INT DEFAULT 'Low' )");
    });
    ...
    it('should be return CREATE TABLE IF NOT EXISTS users ( id INT(10) NOT NULL )', () => {
      ...
      ).toBe('CREATE TABLE IF NOT EXISTS users ( id INT(10) NOT NULL )');
    });
    ...
    it("should be return CREATE TABLE IF NOT EXISTS users ( type VARCHAR NOT NULL, CHECK(type='Image' OR type= 'Location') )", () => {
      expect(
        ...
        "CREATE TABLE IF NOT EXISTS users ( type VARCHAR NOT NULL, CHECK(type='Image' OR type= 'Location') )",
      );
    });
    ...
    it('should be return CREATE TABLE IF NOT EXISTS users ( price DECIMAL(9, 5) NOT NULL )', () => {
      expect(
        ...
        'CREATE TABLE IF NOT EXISTS users ( price DECIMAL(9, 5) NOT NULL )',
      );
    });
    ...
    it('should be return CREATE TABLE IF NOT EXISTS users ( price DECIMAL(9, 5) NOT NULL AUTO_INCREMENT )', () => {
      expect(
        ...
        'CREATE TABLE IF NOT EXISTS users ( price DECIMAL(9, 5) NOT NULL AUTO_INCREMENT )',
      );
    });
  });
});
